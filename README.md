...
## 📌 Overview
This project detects road cracks using deep learning techniques to improve road safety and maintenance efficiency.

---

🎯 Features
- Detects cracks from images
- Uses CNN model
- Provides prediction output
